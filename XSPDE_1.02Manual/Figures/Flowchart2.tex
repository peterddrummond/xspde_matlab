...
\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \node [block, below of=initialize] (integrate1) {{\bf Integrate} a over lattice 1};
     \node [cloud, right of=integrate1] (data) {data };
    ...
    \node [block, below of=decide, node distance=3cm] (graph1) {{\bf Graphics}  };
    ...
    \path [line] (decide) -- node {yes}(graph1);
     ...
     \path [line,dotted] (integrate1) -- (data);
       \path [line,dotted] (integrate2) -- (data);
