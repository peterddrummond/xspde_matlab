function a  =  xRK4(a,xi,dt,r)         
%   a = XRK4(a,xi,dt,r)  propagates a step with fourth-order Runge-Kutta.   
...
r.t = r.t+0.5*dt;                              %%Increment current time         
d2 = 0.5*reshape(r.da(am+d1,xi,r)*dt,r.d.a);   %%Second deriv
d3 = 0.5*reshape(r.da(am+d2,xi,r)*dt,r.d.a);   %%third deriv
r.t = r.t+0.5*dt;                              %%Increment current time
a =  r.prop(am+2.*d3,r);                       %%Last field estimate
d4 = 0.5*reshape(r.da(a,xi,r)*dt,r.d.a);       %%fourth deriv
