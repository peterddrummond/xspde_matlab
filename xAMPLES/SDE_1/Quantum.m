...
T               =  @(p) p.ranges(1);
p.observe{1}    =  @(a,x,p) (2.*pi/T(p))*a(1,:).*conj(a(1,:));
p.observe{2}    =  @(a,x,p) (2.*pi/T(p))*x(1,:).*conj(x(1,:));
p.observe{3}    =  @(a,x,p) (2.*pi/T(p))*x(2,:).*conj(x(2,:));
p.observe{4}    =  @(a,x,p) a(1,:).*conj(a(1,:));
