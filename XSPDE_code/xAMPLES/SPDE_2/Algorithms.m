...
p.name       =  'Algorithms:xMP';                       %%Graph title
...
p.deriv      =  @(a,w,~) 1i*(.005*w+a.*(conj(a).*a)/4); %%Nonlinear deriv
p.linear     =  @(p)     0.5*1i*(p.Dx.^2-1.0);          %%Linear terms
p.method     =  @MP;
p1           =  p;
p2           =  p;
p2.steps     =  40;
p2.name      =  'Algorithms:xImplicit';               
p2.method    =  @Implicit;
p3           =  p;
p3.method    =  @MPadapt;
p3.name      =  'Algorithms:xMPadapt';                  
p4           =  p;
p4.method    =  @RK2;
p4.name      =  'Algorithms:xRK2';                     
p5           =  p;
p5.method    =  @RK4;
p5.name      =  'Algorithms:xRK4';                    
p6           =  p;
p6.method    =  @Euler;
p6.steps     =  40;
p6.name      =  'Algorithms:xEuler';                  
