function input = xwrite(input,data,raw)
%   XWRITE(input,data,raw) writes files produced by xsim.
%   Input:  'data' cell array, ,'input' parameter cell array,
%   'raw' trajectories cell array.
...
case 0                                                %%if Matlab filename
  save (filename,'input','data','raw');               %%save  Matlab file
  return
