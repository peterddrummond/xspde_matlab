function a = JSEB(a,xi,p)
% a = JSEB(a,xi,p) gives a jump in a stochastic Schroedinger equation
% This is the stochastic jump or 'B' term.
% The n-th dissipative operator for mode m is L_nm = sqrt(g_nm)L{n}{m}, 
% with amplitude decay rate g_nm = gamma{n}(m), and master equation:
%
...
%  Should be used with a projected algorithm for normalisation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
