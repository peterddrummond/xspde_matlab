function d = JumpA(psi,~,p)
%d = JumpA(psi,w,p) gives derivatives for stochastic Schroedinger equation
% in a jump form, where this is the non-stochastic A derivative
...
%  If required for speed, the last psi index is an ensemble index
